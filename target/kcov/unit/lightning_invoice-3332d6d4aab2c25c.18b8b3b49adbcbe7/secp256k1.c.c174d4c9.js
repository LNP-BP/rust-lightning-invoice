...
{"lineNum":"   78","line":""},
{"lineNum":"   79","line":"size_t secp256k1_context_preallocated_size(unsigned int flags) {","class":"lineCov","hits":"1","order":"4291","possible_hits":"1",},
{"lineNum":"   80","line":"    size_t ret = ROUND_TO_ALIGN(sizeof(secp256k1_context));","class":"lineCov","hits":"1","order":"4292","possible_hits":"1",},
{"lineNum":"   81","line":""},
{"lineNum":"   82","line":"    if (EXPECT((flags & SECP256K1_FLAGS_TYPE_MASK) != SECP256K1_FLAGS_TYPE_CONTEXT, 0)) {","class":"lineCov","hits":"1","order":"4293","possible_hits":"1",},
...
{"lineNum":"   86","line":"    }"},
{"lineNum":"   87","line":""},
{"lineNum":"   88","line":"    if (flags & SECP256K1_FLAGS_BIT_CONTEXT_SIGN) {","class":"lineCov","hits":"1","order":"4294","possible_hits":"1",},
{"lineNum":"   89","line":"        ret += SECP256K1_ECMULT_GEN_CONTEXT_PREALLOCATED_SIZE;","class":"lineCov","hits":"1","order":"4295","possible_hits":"1",},
{"lineNum":"   90","line":"    }"},
{"lineNum":"   91","line":"    if (flags & SECP256K1_FLAGS_BIT_CONTEXT_VERIFY) {","class":"lineCov","hits":"1","order":"4296","possible_hits":"1",},
{"lineNum":"   92","line":"        ret += SECP256K1_ECMULT_CONTEXT_PREALLOCATED_SIZE;","class":"lineCov","hits":"1","order":"4297","possible_hits":"1",},
{"lineNum":"   93","line":"    }"},
{"lineNum":"   94","line":"    return ret;","class":"lineCov","hits":"1","order":"4298","possible_hits":"1",},
{"lineNum":"   95","line":"}","class":"linePartCov","hits":"1","order":"4299","possible_hits":"2",},
{"lineNum":"   96","line":""},
...
{"lineNum":"  107","line":"}"},
{"lineNum":"  108","line":""},
{"lineNum":"  109","line":"secp256k1_context* secp256k1_context_preallocated_create(void* prealloc, unsigned int flags) {","class":"lineCov","hits":"1","order":"4336","possible_hits":"1",},
{"lineNum":"  110","line":"    void* const base = prealloc;","class":"lineCov","hits":"1","order":"4337","possible_hits":"1",},
{"lineNum":"  111","line":"    size_t prealloc_size;"},
{"lineNum":"  112","line":"    secp256k1_context* ret;"},
{"lineNum":"  113","line":""},
{"lineNum":"  114","line":"    VERIFY_CHECK(prealloc != NULL);"},
{"lineNum":"  115","line":"    prealloc_size = secp256k1_context_preallocated_size(flags);","class":"lineCov","hits":"1","order":"4338","possible_hits":"1",},
{"lineNum":"  116","line":"    ret = (secp256k1_context*)manual_alloc(&prealloc, sizeof(secp256k1_context), base, prealloc_size);","class":"lineCov","hits":"1","order":"4339","possible_hits":"1",},
{"lineNum":"  117","line":"    ret->illegal_callback = default_illegal_callback;","class":"lineCov","hits":"1","order":"4346","possible_hits":"1",},
{"lineNum":"  118","line":"    ret->error_callback = default_error_callback;","class":"lineCov","hits":"1","order":"4347","possible_hits":"1",},
{"lineNum":"  119","line":""},
{"lineNum":"  120","line":"    if (EXPECT((flags & SECP256K1_FLAGS_TYPE_MASK) != SECP256K1_FLAGS_TYPE_CONTEXT, 0)) {","class":"lineCov","hits":"1","order":"4348","possible_hits":"1",},
...
{"lineNum":"  124","line":"    }"},
{"lineNum":"  125","line":""},
{"lineNum":"  126","line":"    secp256k1_ecmult_context_init(&ret->ecmult_ctx);","class":"lineCov","hits":"1","order":"4349","possible_hits":"1",},
{"lineNum":"  127","line":"    secp256k1_ecmult_gen_context_init(&ret->ecmult_gen_ctx);","class":"lineCov","hits":"1","order":"4353","possible_hits":"1",},
{"lineNum":"  128","line":""},
{"lineNum":"  129","line":"    if (flags & SECP256K1_FLAGS_BIT_CONTEXT_SIGN) {","class":"lineCov","hits":"1","order":"4357","possible_hits":"1",},
{"lineNum":"  130","line":"        secp256k1_ecmult_gen_context_build(&ret->ecmult_gen_ctx, &prealloc);","class":"lineCov","hits":"1","order":"4358","possible_hits":"1",},
{"lineNum":"  131","line":"    }"},
{"lineNum":"  132","line":"    if (flags & SECP256K1_FLAGS_BIT_CONTEXT_VERIFY) {","class":"lineCov","hits":"1","order":"5031","possible_hits":"1",},
{"lineNum":"  133","line":"        secp256k1_ecmult_context_build(&ret->ecmult_ctx, &prealloc);","class":"lineCov","hits":"1","order":"5032","possible_hits":"1",},
{"lineNum":"  134","line":"    }"},
{"lineNum":"  135","line":""},
{"lineNum":"  136","line":"    return (secp256k1_context*) ret;","class":"lineCov","hits":"1","order":"5080","possible_hits":"1",},
{"lineNum":"  137","line":"}","class":"linePartCov","hits":"1","order":"5081","possible_hits":"2",},
{"lineNum":"  138","line":""},
...
{"lineNum":"  151","line":"}"},
{"lineNum":"  152","line":""},
{"lineNum":"  153","line":"void secp256k1_context_preallocated_destroy(secp256k1_context* ctx) {","class":"lineCov","hits":"1","order":"6001","possible_hits":"1",},
{"lineNum":"  154","line":"    ARG_CHECK_NO_RETURN(ctx != secp256k1_context_no_precomp);","class":"lineCov","hits":"1","order":"6002","possible_hits":"1",},
{"lineNum":"  155","line":"    if (ctx != NULL) {","class":"lineCov","hits":"1","order":"6003","possible_hits":"1",},
{"lineNum":"  156","line":"        secp256k1_ecmult_context_clear(&ctx->ecmult_ctx);","class":"lineCov","hits":"1","order":"6004","possible_hits":"1",},
{"lineNum":"  157","line":"        secp256k1_ecmult_gen_context_clear(&ctx->ecmult_gen_ctx);","class":"lineCov","hits":"1","order":"6008","possible_hits":"1",},
{"lineNum":"  158","line":"    }"},
{"lineNum":"  159","line":"}","class":"linePartCov","hits":"1","order":"6014","possible_hits":"2",},
{"lineNum":"  160","line":""},
...
{"lineNum":"  177","line":"}"},
{"lineNum":"  178","line":""},
{"lineNum":"  179","line":"static int secp256k1_pubkey_load(const secp256k1_context* ctx, secp256k1_ge* ge, const secp256k1_pubkey* pubkey) {","class":"lineCov","hits":"2","order":"5257","possible_hits":"2",},
...
{"lineNum":"  185","line":"        memcpy(&s, &pubkey->data[0], sizeof(s));","class":"lineCov","hits":"1","order":"5258","possible_hits":"1",},
{"lineNum":"  186","line":"        secp256k1_ge_from_storage(ge, &s);","class":"lineCov","hits":"1","order":"5259","possible_hits":"1",},
...
{"lineNum":"  193","line":"    }"},
{"lineNum":"  194","line":"    ARG_CHECK(!secp256k1_fe_is_zero(&ge->x));","class":"lineCov","hits":"1","order":"5260","possible_hits":"1",},
{"lineNum":"  195","line":"    return 1;","class":"lineCov","hits":"1","order":"5261","possible_hits":"1",},
{"lineNum":"  196","line":"}","class":"linePartCov","hits":"1","order":"5262","possible_hits":"2",},
{"lineNum":"  197","line":""},
{"lineNum":"  198","line":"static void secp256k1_pubkey_save(secp256k1_pubkey* pubkey, secp256k1_ge* ge) {","class":"lineCov","hits":"2","order":"2681","possible_hits":"2",},
{"lineNum":"  199","line":"    if (sizeof(secp256k1_ge_storage) == 64) {"},
{"lineNum":"  200","line":"        secp256k1_ge_storage s;"},
{"lineNum":"  201","line":"        secp256k1_ge_to_storage(&s, ge);","class":"lineCov","hits":"1","order":"2682","possible_hits":"1",},
{"lineNum":"  202","line":"        memcpy(&pubkey->data[0], &s, sizeof(s));","class":"lineCov","hits":"1","order":"2715","possible_hits":"1",},
...
{"lineNum":"  209","line":"    }"},
{"lineNum":"  210","line":"}","class":"linePartCov","hits":"1","order":"2716","possible_hits":"2",},
{"lineNum":"  211","line":""},
{"lineNum":"  212","line":"int secp256k1_ec_pubkey_parse(const secp256k1_context* ctx, secp256k1_pubkey* pubkey, const unsigned char *input, size_t inputlen) {","class":"lineCov","hits":"2","order":"2424","possible_hits":"2",},
{"lineNum":"  213","line":"    secp256k1_ge Q;"},
{"lineNum":"  214","line":""},
{"lineNum":"  215","line":"    VERIFY_CHECK(ctx != NULL);"},
{"lineNum":"  216","line":"    ARG_CHECK(pubkey != NULL);","class":"lineCov","hits":"1","order":"2425","possible_hits":"1",},
{"lineNum":"  217","line":"    memset(pubkey, 0, sizeof(*pubkey));","class":"lineCov","hits":"1","order":"2426","possible_hits":"1",},
{"lineNum":"  218","line":"    ARG_CHECK(input != NULL);","class":"lineCov","hits":"1","order":"2427","possible_hits":"1",},
{"lineNum":"  219","line":"    if (!secp256k1_eckey_pubkey_parse(&Q, input, inputlen)) {","class":"lineCov","hits":"1","order":"2428","possible_hits":"1",},
{"lineNum":"  220","line":"        return 0;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  221","line":"    }"},
{"lineNum":"  222","line":"    secp256k1_pubkey_save(pubkey, &Q);","class":"lineCov","hits":"1","order":"2680","possible_hits":"1",},
{"lineNum":"  223","line":"    secp256k1_ge_clear(&Q);","class":"lineCov","hits":"1","order":"2717","possible_hits":"1",},
{"lineNum":"  224","line":"    return 1;","class":"lineCov","hits":"1","order":"2727","possible_hits":"1",},
{"lineNum":"  225","line":"}","class":"lineCov","hits":"1","order":"2728","possible_hits":"1",},
{"lineNum":"  226","line":""},
{"lineNum":"  227","line":"int secp256k1_ec_pubkey_serialize(const secp256k1_context* ctx, unsigned char *output, size_t *outputlen, const secp256k1_pubkey* pubkey, unsigned int flags) {","class":"lineCov","hits":"2","order":"5246","possible_hits":"2",},
{"lineNum":"  228","line":"    secp256k1_ge Q;"},
{"lineNum":"  229","line":"    size_t len;"},
{"lineNum":"  230","line":"    int ret = 0;","class":"lineCov","hits":"1","order":"5247","possible_hits":"1",},
{"lineNum":"  231","line":""},
{"lineNum":"  232","line":"    VERIFY_CHECK(ctx != NULL);"},
{"lineNum":"  233","line":"    ARG_CHECK(outputlen != NULL);","class":"lineCov","hits":"1","order":"5248","possible_hits":"1",},
{"lineNum":"  234","line":"    ARG_CHECK(*outputlen >= ((flags & SECP256K1_FLAGS_BIT_COMPRESSION) ? 33 : 65));","class":"lineCov","hits":"1","order":"5249","possible_hits":"1",},
{"lineNum":"  235","line":"    len = *outputlen;","class":"lineCov","hits":"1","order":"5250","possible_hits":"1",},
{"lineNum":"  236","line":"    *outputlen = 0;","class":"lineCov","hits":"1","order":"5251","possible_hits":"1",},
{"lineNum":"  237","line":"    ARG_CHECK(output != NULL);","class":"lineCov","hits":"1","order":"5252","possible_hits":"1",},
{"lineNum":"  238","line":"    memset(output, 0, len);","class":"lineCov","hits":"1","order":"5253","possible_hits":"1",},
{"lineNum":"  239","line":"    ARG_CHECK(pubkey != NULL);","class":"lineCov","hits":"1","order":"5254","possible_hits":"1",},
{"lineNum":"  240","line":"    ARG_CHECK((flags & SECP256K1_FLAGS_TYPE_MASK) == SECP256K1_FLAGS_TYPE_COMPRESSION);","class":"lineCov","hits":"1","order":"5255","possible_hits":"1",},
{"lineNum":"  241","line":"    if (secp256k1_pubkey_load(ctx, &Q, pubkey)) {","class":"lineCov","hits":"1","order":"5256","possible_hits":"1",},
{"lineNum":"  242","line":"        ret = secp256k1_eckey_pubkey_serialize(&Q, output, &len, flags & SECP256K1_FLAGS_BIT_COMPRESSION);","class":"lineCov","hits":"1","order":"5263","possible_hits":"1",},
{"lineNum":"  243","line":"        if (ret) {","class":"lineCov","hits":"1","order":"5311","possible_hits":"1",},
{"lineNum":"  244","line":"            *outputlen = len;","class":"lineCov","hits":"1","order":"5312","possible_hits":"1",},
{"lineNum":"  245","line":"        }"},
{"lineNum":"  246","line":"    }"},
{"lineNum":"  247","line":"    return ret;","class":"lineCov","hits":"1","order":"5313","possible_hits":"1",},
{"lineNum":"  248","line":"}","class":"lineCov","hits":"1","order":"5314","possible_hits":"1",},
{"lineNum":"  249","line":""},
{"lineNum":"  250","line":"static void secp256k1_ecdsa_signature_load(const secp256k1_context* ctx, secp256k1_scalar* r, secp256k1_scalar* s, const secp256k1_ecdsa_signature* sig) {","class":"lineCov","hits":"1","order":"6093","possible_hits":"1",},
...
{"lineNum":"  256","line":"        memcpy(r, &sig->data[0], 32);","class":"lineCov","hits":"1","order":"6094","possible_hits":"1",},
{"lineNum":"  257","line":"        memcpy(s, &sig->data[32], 32);","class":"lineCov","hits":"1","order":"6095","possible_hits":"1",},
...
{"lineNum":"  261","line":"    }"},
{"lineNum":"  262","line":"}","class":"linePartCov","hits":"1","order":"6096","possible_hits":"2",},
{"lineNum":"  263","line":""},
{"lineNum":"  264","line":"static void secp256k1_ecdsa_signature_save(secp256k1_ecdsa_signature* sig, const secp256k1_scalar* r, const secp256k1_scalar* s) {","class":"lineCov","hits":"1","order":"6068","possible_hits":"1",},
{"lineNum":"  265","line":"    if (sizeof(secp256k1_scalar) == 32) {"},
{"lineNum":"  266","line":"        memcpy(&sig->data[0], r, 32);","class":"lineCov","hits":"1","order":"6069","possible_hits":"1",},
{"lineNum":"  267","line":"        memcpy(&sig->data[32], s, 32);","class":"lineCov","hits":"1","order":"6070","possible_hits":"1",},
...
{"lineNum":"  271","line":"    }"},
{"lineNum":"  272","line":"}","class":"linePartCov","hits":"1","order":"6071","possible_hits":"2",},
{"lineNum":"  273","line":""},
...
{"lineNum":"  353","line":"}"},
{"lineNum":"  354","line":""},
{"lineNum":"  355","line":"int secp256k1_ecdsa_verify(const secp256k1_context* ctx, const secp256k1_ecdsa_signature *sig, const unsigned char *msg32, const secp256k1_pubkey *pubkey) {","class":"lineCov","hits":"2","order":"6086","possible_hits":"2",},
...
{"lineNum":"  360","line":"    ARG_CHECK(secp256k1_ecmult_context_is_built(&ctx->ecmult_ctx));","class":"lineCov","hits":"1","order":"6087","possible_hits":"1",},
{"lineNum":"  361","line":"    ARG_CHECK(msg32 != NULL);","class":"lineCov","hits":"1","order":"6088","possible_hits":"1",},
{"lineNum":"  362","line":"    ARG_CHECK(sig != NULL);","class":"lineCov","hits":"1","order":"6089","possible_hits":"1",},
{"lineNum":"  363","line":"    ARG_CHECK(pubkey != NULL);","class":"lineCov","hits":"1","order":"6090","possible_hits":"1",},
{"lineNum":"  364","line":""},
{"lineNum":"  365","line":"    secp256k1_scalar_set_b32(&m, msg32, NULL);","class":"lineCov","hits":"1","order":"6091","possible_hits":"1",},
{"lineNum":"  366","line":"    secp256k1_ecdsa_signature_load(ctx, &r, &s, sig);","class":"lineCov","hits":"1","order":"6092","possible_hits":"1",},
{"lineNum":"  367","line":"    return (!secp256k1_scalar_is_high(&s) &&","class":"lineCov","hits":"3","order":"6097","possible_hits":"3",},
{"lineNum":"  368","line":"            secp256k1_pubkey_load(ctx, &q, pubkey) &&","class":"lineCov","hits":"2","order":"6098","possible_hits":"2",},
{"lineNum":"  369","line":"            secp256k1_ecdsa_sig_verify(&ctx->ecmult_ctx, &r, &s, &q, &m));","class":"lineCov","hits":"1","order":"6099","possible_hits":"1",},
{"lineNum":"  370","line":"}","class":"lineCov","hits":"1","order":"6143","possible_hits":"1",},
{"lineNum":"  371","line":""},
{"lineNum":"  372","line":"static SECP256K1_INLINE void buffer_append(unsigned char *buf, unsigned int *offset, const void *data, unsigned int len) {","class":"lineCov","hits":"1","order":"5673","possible_hits":"1",},
{"lineNum":"  373","line":"    memcpy(buf + *offset, data, len);","class":"lineCov","hits":"1","order":"5675","possible_hits":"1",},
{"lineNum":"  374","line":"    *offset += len;","class":"lineCov","hits":"1","order":"5676","possible_hits":"1",},
{"lineNum":"  375","line":"}","class":"linePartCov","hits":"1","order":"5678","possible_hits":"2",},
{"lineNum":"  376","line":""},
{"lineNum":"  377","line":"static int nonce_function_rfc6979(unsigned char *nonce32, const unsigned char *msg32, const unsigned char *key32, const unsigned char *algo16, void *data, unsigned int counter) {","class":"lineCov","hits":"2","order":"5667","possible_hits":"2",},
{"lineNum":"  378","line":"   unsigned char keydata[112];"},
{"lineNum":"  379","line":"   unsigned int offset = 0;","class":"lineCov","hits":"1","order":"5669","possible_hits":"1",},
...
{"lineNum":"  389","line":"    */"},
{"lineNum":"  390","line":"   buffer_append(keydata, &offset, key32, 32);","class":"lineCov","hits":"1","order":"5671","possible_hits":"1",},
{"lineNum":"  391","line":"   buffer_append(keydata, &offset, msg32, 32);","class":"lineCov","hits":"1","order":"5680","possible_hits":"1",},
{"lineNum":"  392","line":"   if (data != NULL) {","class":"lineCov","hits":"1","order":"5682","possible_hits":"1",},
{"lineNum":"  393","line":"       buffer_append(keydata, &offset, data, 32);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  394","line":"   }"},
{"lineNum":"  395","line":"   if (algo16 != NULL) {","class":"lineCov","hits":"1","order":"5683","possible_hits":"1",},
{"lineNum":"  396","line":"       buffer_append(keydata, &offset, algo16, 16);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  397","line":"   }"},
{"lineNum":"  398","line":"   secp256k1_rfc6979_hmac_sha256_initialize(&rng, keydata, offset);","class":"lineCov","hits":"1","order":"5685","possible_hits":"1",},
{"lineNum":"  399","line":"   memset(keydata, 0, sizeof(keydata));","class":"lineCov","hits":"1","order":"5687","possible_hits":"1",},
{"lineNum":"  400","line":"   for (i = 0; i <= counter; i++) {","class":"lineCov","hits":"2","order":"5689","possible_hits":"2",},
{"lineNum":"  401","line":"       secp256k1_rfc6979_hmac_sha256_generate(&rng, nonce32, 32);","class":"lineCov","hits":"1","order":"5690","possible_hits":"1",},
{"lineNum":"  402","line":"   }"},
{"lineNum":"  403","line":"   secp256k1_rfc6979_hmac_sha256_finalize(&rng);","class":"lineCov","hits":"1","order":"5693","possible_hits":"1",},
{"lineNum":"  404","line":"   return 1;","class":"lineCov","hits":"1","order":"5695","possible_hits":"1",},
{"lineNum":"  405","line":"}","class":"linePartCov","hits":"1","order":"5696","possible_hits":"2",},
{"lineNum":"  406","line":""},
...
{"lineNum":"  454","line":"}"},
{"lineNum":"  455","line":""},
{"lineNum":"  456","line":"int secp256k1_ec_seckey_verify(const secp256k1_context* ctx, const unsigned char *seckey) {","class":"lineCov","hits":"2","order":"5094","possible_hits":"2",},
...
{"lineNum":"  461","line":"    ARG_CHECK(seckey != NULL);","class":"lineCov","hits":"1","order":"5095","possible_hits":"1",},
{"lineNum":"  462","line":""},
{"lineNum":"  463","line":"    secp256k1_scalar_set_b32(&sec, seckey, &overflow);","class":"lineCov","hits":"1","order":"5096","possible_hits":"1",},
{"lineNum":"  464","line":"    ret = !overflow && !secp256k1_scalar_is_zero(&sec);","class":"lineCov","hits":"1","order":"5097","possible_hits":"1",},
{"lineNum":"  465","line":"    secp256k1_scalar_clear(&sec);","class":"lineCov","hits":"1","order":"5098","possible_hits":"1",},
{"lineNum":"  466","line":"    return ret;","class":"lineCov","hits":"1","order":"5099","possible_hits":"1",},
{"lineNum":"  467","line":"}","class":"lineCov","hits":"1","order":"5100","possible_hits":"1",},
{"lineNum":"  468","line":""},
{"lineNum":"  469","line":"int secp256k1_ec_pubkey_create(const secp256k1_context* ctx, secp256k1_pubkey *pubkey, const unsigned char *seckey) {","class":"lineCov","hits":"2","order":"5117","possible_hits":"2",},
...
{"lineNum":"  474","line":"    int ret = 0;","class":"lineCov","hits":"1","order":"5118","possible_hits":"1",},
{"lineNum":"  475","line":"    VERIFY_CHECK(ctx != NULL);"},
{"lineNum":"  476","line":"    ARG_CHECK(pubkey != NULL);","class":"lineCov","hits":"1","order":"5119","possible_hits":"1",},
{"lineNum":"  477","line":"    memset(pubkey, 0, sizeof(*pubkey));","class":"lineCov","hits":"1","order":"5120","possible_hits":"1",},
{"lineNum":"  478","line":"    ARG_CHECK(secp256k1_ecmult_gen_context_is_built(&ctx->ecmult_gen_ctx));","class":"lineCov","hits":"1","order":"5121","possible_hits":"1",},
{"lineNum":"  479","line":"    ARG_CHECK(seckey != NULL);","class":"lineCov","hits":"1","order":"5125","possible_hits":"1",},
{"lineNum":"  480","line":""},
{"lineNum":"  481","line":"    secp256k1_scalar_set_b32(&sec, seckey, &overflow);","class":"lineCov","hits":"1","order":"5126","possible_hits":"1",},
{"lineNum":"  482","line":"    ret = (!overflow) & (!secp256k1_scalar_is_zero(&sec));","class":"lineCov","hits":"1","order":"5127","possible_hits":"1",},
{"lineNum":"  483","line":"    if (ret) {","class":"lineCov","hits":"1","order":"5128","possible_hits":"1",},
{"lineNum":"  484","line":"        secp256k1_ecmult_gen(&ctx->ecmult_gen_ctx, &pj, &sec);","class":"lineCov","hits":"1","order":"5129","possible_hits":"1",},
{"lineNum":"  485","line":"        secp256k1_ge_set_gej(&p, &pj);","class":"lineCov","hits":"1","order":"5130","possible_hits":"1",},
{"lineNum":"  486","line":"        secp256k1_pubkey_save(pubkey, &p);","class":"lineCov","hits":"1","order":"5142","possible_hits":"1",},
{"lineNum":"  487","line":"    }"},
{"lineNum":"  488","line":"    secp256k1_scalar_clear(&sec);","class":"lineCov","hits":"1","order":"5143","possible_hits":"1",},
{"lineNum":"  489","line":"    return ret;","class":"lineCov","hits":"1","order":"5144","possible_hits":"1",},
{"lineNum":"  490","line":"}","class":"lineCov","hits":"1","order":"5145","possible_hits":"1",},
{"lineNum":"  491","line":""},
...
var header = { "command" : "lightning_invoice-3332d6d4aab2c25c", "date" : "2020-05-23 13:12:48", "instrumented" : 130, "covered" : 123,};
var merged_data = [];
