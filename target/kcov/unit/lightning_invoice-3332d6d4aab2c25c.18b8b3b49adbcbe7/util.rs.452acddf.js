...
{"lineNum":"   82","line":"            fn index(&self, index: $crate::core::ops::RangeFull) -> &[u8] {","class":"lineCov","hits":"1","order":"3757","possible_hits":"1",},
{"lineNum":"   83","line":"                &self.0[index]","class":"lineCov","hits":"1","order":"3758","possible_hits":"1",},
{"lineNum":"   84","line":"            }","class":"linePartCov","hits":"1","order":"3759","possible_hits":"2",},
{"lineNum":"   85","line":"        }"},
{"lineNum":"   86","line":"    )"},
{"lineNum":"   87","line":");"},
{"lineNum":"   88","line":""},
...
{"lineNum":"  121","line":"        fn input(&mut self, mut inp: &[u8]) {","class":"lineCov","hits":"1","order":"3573","possible_hits":"1",},
{"lineNum":"  122","line":"            while !inp.is_empty() {","class":"lineCov","hits":"2","order":"3574","possible_hits":"2",},
{"lineNum":"  123","line":"                let buf_idx = self.length % <Self as EngineTrait>::BLOCK_SIZE;","class":"lineCov","hits":"1","order":"3575","possible_hits":"1",},
{"lineNum":"  124","line":"                let rem_len = <Self as EngineTrait>::BLOCK_SIZE - buf_idx;","class":"linePartCov","hits":"1","order":"3576","possible_hits":"2",},
{"lineNum":"  125","line":"                let write_len = cmp::min(rem_len, inp.len());","class":"lineCov","hits":"1","order":"3577","possible_hits":"1",},
{"lineNum":"  126","line":""},
{"lineNum":"  127","line":"                self.buffer[buf_idx..buf_idx + write_len]","class":"linePartCov","hits":"2","order":"3578","possible_hits":"3",},
{"lineNum":"  128","line":"                    .copy_from_slice(&inp[..write_len]);","class":"lineCov","hits":"1","order":"3579","possible_hits":"1",},
{"lineNum":"  129","line":"                self.length += write_len;","class":"linePartCov","hits":"1","order":"3580","possible_hits":"3",},
{"lineNum":"  130","line":"                if self.length % <Self as EngineTrait>::BLOCK_SIZE == 0 {","class":"lineCov","hits":"2","order":"3581","possible_hits":"2",},
{"lineNum":"  131","line":"                    self.process_block();","class":"lineCov","hits":"1","order":"3582","possible_hits":"1",},
{"lineNum":"  132","line":"                }"},
{"lineNum":"  133","line":"                inp = &inp[write_len..];","class":"lineCov","hits":"1","order":"3706","possible_hits":"1",},
{"lineNum":"  134","line":"            }"},
{"lineNum":"  135","line":"        }","class":"lineCov","hits":"1","order":"3708","possible_hits":"1",},
{"lineNum":"  136","line":""},
...
{"lineNum":"  152","line":"        pub fn $name(slice: &[u8]) -> $type {","class":"lineCov","hits":"1","order":"3616","possible_hits":"1",},
{"lineNum":"  153","line":"            assert_eq!(slice.len(), ::core::mem::size_of::<$type>());","class":"linePartCov","hits":"1","order":"3617","possible_hits":"2",},
{"lineNum":"  154","line":"            let mut res = 0;","class":"lineCov","hits":"1","order":"3618","possible_hits":"1",},
{"lineNum":"  155","line":"            for i in 0..::core::mem::size_of::<$type>() {","class":"linePartCov","hits":"3","order":"3619","possible_hits":"4",},
{"lineNum":"  156","line":"                res |= (slice[i] as $type) << (::core::mem::size_of::<$type>() - i - 1)*8;","class":"linePartCov","hits":"2","order":"3620","possible_hits":"3",},
{"lineNum":"  157","line":"            }"},
{"lineNum":"  158","line":"            res","class":"lineCov","hits":"1","order":"3621","possible_hits":"1",},
{"lineNum":"  159","line":"        }","class":"lineCov","hits":"1","order":"3622","possible_hits":"1",},
{"lineNum":"  160","line":"    }"},
{"lineNum":"  161","line":"}"},
...
{"lineNum":"  178","line":"        pub fn $name(val: $type) -> [u8; $byte_len] {","class":"lineCov","hits":"2","order":"3719","possible_hits":"2",},
{"lineNum":"  179","line":"            assert_eq!(::core::mem::size_of::<$type>(), $byte_len); // size_of isn\'t a constfn in 1.22","class":"linePartCov","hits":"2","order":"3720","possible_hits":"4",},
{"lineNum":"  180","line":"            let mut res = [0; $byte_len];","class":"lineCov","hits":"2","order":"3721","possible_hits":"2",},
{"lineNum":"  181","line":"            for i in 0..$byte_len {","class":"linePartCov","hits":"6","order":"3722","possible_hits":"8",},
{"lineNum":"  182","line":"                res[i] = ((val >> ($byte_len - i - 1)*8) & 0xff) as u8;","class":"linePartCov","hits":"2","order":"3723","possible_hits":"4",},
{"lineNum":"  183","line":"            }"},
{"lineNum":"  184","line":"            res","class":"lineCov","hits":"2","order":"3724","possible_hits":"2",},
{"lineNum":"  185","line":"        }","class":"lineCov","hits":"2","order":"3725","possible_hits":"2",},
{"lineNum":"  186","line":"    }"},
{"lineNum":"  187","line":"}"},
...
var header = { "command" : "lightning_invoice-3332d6d4aab2c25c", "date" : "2020-05-23 13:12:48", "instrumented" : 32, "covered" : 29,};
var merged_data = [];
