...
{"lineNum":"   35","line":"#[derive(Copy, Clone, PartialEq, Eq, Debug)]","class":"linePartCov","hits":"2","order":"3919","possible_hits":"6",},
{"lineNum":"   36","line":"pub struct RecoverableSignature(ffi::RecoverableSignature);","class":"linePartCov","hits":"1","order":"3920","possible_hits":"3",},
{"lineNum":"   37","line":""},
...
{"lineNum":"   41","line":"pub fn from_i32(id: i32) -> Result<RecoveryId, Error> {","class":"lineCov","hits":"1","order":"3770","possible_hits":"1",},
{"lineNum":"   42","line":"    match id {","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   43","line":"        0 | 1 | 2 | 3 => Ok(RecoveryId(id)),","class":"lineCov","hits":"2","order":"3771","possible_hits":"2",},
{"lineNum":"   44","line":"        _ => Err(Error::InvalidRecoveryId)","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   45","line":"    }"},
{"lineNum":"   46","line":"}","class":"linePartCov","hits":"1","order":"3772","possible_hits":"2",},
{"lineNum":"   47","line":""},
{"lineNum":"   48","line":"#[inline]"},
{"lineNum":"   49","line":"/// Allows library users to convert recovery IDs to i32."},
{"lineNum":"   50","line":"pub fn to_i32(self) -> i32 {"},
...
{"lineNum":"   60","line":"    pub fn from_compact(data: &[u8], recid: RecoveryId) -> Result<RecoverableSignature, Error> {","class":"lineCov","hits":"1","order":"3774","possible_hits":"1",},
{"lineNum":"   61","line":"        if data.is_empty() {return Err(Error::InvalidSignature);}","class":"linePartCov","hits":"1","order":"3775","possible_hits":"2",},
{"lineNum":"   62","line":""},
{"lineNum":"   63","line":"        let mut ret = ffi::RecoverableSignature::new();","class":"lineCov","hits":"1","order":"3777","possible_hits":"1",},
{"lineNum":"   64","line":""},
{"lineNum":"   65","line":"        unsafe {"},
{"lineNum":"   66","line":"            if data.len() != 64 {","class":"linePartCov","hits":"2","order":"3780","possible_hits":"3",},
{"lineNum":"   67","line":"                Err(Error::InvalidSignature)","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   68","line":"            } else if ffi::secp256k1_ecdsa_recoverable_signature_parse_compact(","class":"linePartCov","hits":"1","order":"3786","possible_hits":"2",},
{"lineNum":"   69","line":"                super_ffi::secp256k1_context_no_precomp,","class":"lineCov","hits":"1","order":"3782","possible_hits":"1",},
{"lineNum":"   70","line":"                &mut ret,"},
{"lineNum":"   71","line":"                data.as_c_ptr(),","class":"lineCov","hits":"1","order":"3784","possible_hits":"1",},
{"lineNum":"   72","line":"                recid.0,"},
{"lineNum":"   73","line":"            ) == 1"},
{"lineNum":"   74","line":"            {"},
{"lineNum":"   75","line":"                Ok(RecoverableSignature(ret))","class":"lineCov","hits":"1","order":"3853","possible_hits":"1",},
{"lineNum":"   76","line":"            } else {"},
{"lineNum":"   77","line":"                Err(Error::InvalidSignature)","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   78","line":"            }"},
{"lineNum":"   79","line":"        }"},
{"lineNum":"   80","line":"    }","class":"linePartCov","hits":"2","order":"3854","possible_hits":"3",},
{"lineNum":"   81","line":""},
{"lineNum":"   82","line":"    /// Obtains a raw pointer suitable for use with FFI functions"},
{"lineNum":"   83","line":"    #[inline]"},
{"lineNum":"   84","line":"    pub fn as_ptr(&self) -> *const ffi::RecoverableSignature {","class":"lineCov","hits":"1","order":"5407","possible_hits":"1",},
{"lineNum":"   85","line":"        &self.0 as *const _"},
{"lineNum":"   86","line":"    }","class":"linePartCov","hits":"1","order":"5409","possible_hits":"2",},
{"lineNum":"   87","line":""},
...
{"lineNum":"   96","line":"    pub fn serialize_compact(&self) -> (RecoveryId, [u8; 64]) {"},
{"lineNum":"   97","line":"        let mut ret = [0u8; 64];"},
{"lineNum":"   98","line":"        let mut recid = 0i32;"},
{"lineNum":"   99","line":"        unsafe {"},
{"lineNum":"  100","line":"            let err = ffi::secp256k1_ecdsa_recoverable_signature_serialize_compact("},
{"lineNum":"  101","line":"                super_ffi::secp256k1_context_no_precomp,"},
{"lineNum":"  102","line":"                ret.as_mut_c_ptr(),"},
{"lineNum":"  103","line":"                &mut recid,"},
{"lineNum":"  104","line":"                self.as_c_ptr(),"},
{"lineNum":"  105","line":"            );"},
{"lineNum":"  106","line":"            assert!(err == 1);"},
{"lineNum":"  107","line":"        }"},
{"lineNum":"  108","line":"        (RecoveryId(recid), ret)"},
{"lineNum":"  109","line":"    }"},
{"lineNum":"  110","line":""},
...
{"lineNum":"  114","line":"    pub fn to_standard(&self) -> Signature {","class":"lineCov","hits":"1","order":"6057","possible_hits":"1",},
{"lineNum":"  115","line":"        let mut ret = super_ffi::Signature::new();","class":"lineCov","hits":"1","order":"6058","possible_hits":"1",},
{"lineNum":"  116","line":"        unsafe {"},
{"lineNum":"  117","line":"            let err = ffi::secp256k1_ecdsa_recoverable_signature_convert(","class":"lineCov","hits":"1","order":"6062","possible_hits":"1",},
{"lineNum":"  118","line":"                super_ffi::secp256k1_context_no_precomp,","class":"lineCov","hits":"1","order":"6060","possible_hits":"1",},
{"lineNum":"  119","line":"                &mut ret,"},
{"lineNum":"  120","line":"                self.as_c_ptr(),","class":"lineCov","hits":"1","order":"6061","possible_hits":"1",},
{"lineNum":"  121","line":"            );"},
{"lineNum":"  122","line":"            assert!(err == 1);","class":"lineCov","hits":"1","order":"6074","possible_hits":"1",},
{"lineNum":"  123","line":"        }"},
{"lineNum":"  124","line":"        Signature(ret)","class":"lineCov","hits":"1","order":"6075","possible_hits":"1",},
{"lineNum":"  125","line":"    }","class":"lineCov","hits":"1","order":"6076","possible_hits":"1",},
{"lineNum":"  126","line":"}"},
{"lineNum":"  127","line":""},
{"lineNum":"  128","line":""},
{"lineNum":"  129","line":"impl CPtr for RecoverableSignature {"},
{"lineNum":"  130","line":"    type Target = ffi::RecoverableSignature;"},
{"lineNum":"  131","line":"    fn as_c_ptr(&self) -> *const Self::Target {","class":"lineCov","hits":"1","order":"5404","possible_hits":"1",},
{"lineNum":"  132","line":"        self.as_ptr()","class":"lineCov","hits":"1","order":"5405","possible_hits":"1",},
{"lineNum":"  133","line":"    }","class":"linePartCov","hits":"1","order":"5410","possible_hits":"2",},
{"lineNum":"  134","line":""},
...
{"lineNum":"  143","line":"    fn from(sig: ffi::RecoverableSignature) -> RecoverableSignature {","class":"lineCov","hits":"1","order":"5815","possible_hits":"1",},
{"lineNum":"  144","line":"        RecoverableSignature(sig)","class":"lineCov","hits":"1","order":"5817","possible_hits":"1",},
{"lineNum":"  145","line":"    }","class":"linePartCov","hits":"1","order":"5819","possible_hits":"2",},
{"lineNum":"  146","line":"}"},
{"lineNum":"  147","line":""},
...
{"lineNum":"  151","line":"    pub fn sign_recoverable(&self, msg: &Message, sk: &key::SecretKey)","class":"lineCov","hits":"1","order":"5634","possible_hits":"1",},
{"lineNum":"  152","line":"                            -> RecoverableSignature {"},
{"lineNum":"  153","line":""},
{"lineNum":"  154","line":"        let mut ret = ffi::RecoverableSignature::new();","class":"lineCov","hits":"1","order":"5636","possible_hits":"1",},
...
{"lineNum":"  159","line":"                ffi::secp256k1_ecdsa_sign_recoverable(","class":"lineCov","hits":"1","order":"5644","possible_hits":"1",},
{"lineNum":"  160","line":"                    self.ctx,","class":"lineCov","hits":"1","order":"5638","possible_hits":"1",},
{"lineNum":"  161","line":"                    &mut ret,"},
{"lineNum":"  162","line":"                    msg.as_c_ptr(),","class":"lineCov","hits":"1","order":"5639","possible_hits":"1",},
{"lineNum":"  163","line":"                    sk.as_c_ptr(),","class":"lineCov","hits":"1","order":"5641","possible_hits":"1",},
{"lineNum":"  164","line":"                    super_ffi::secp256k1_nonce_function_rfc6979,","class":"lineCov","hits":"1","order":"5642","possible_hits":"1",},
...
{"lineNum":"  169","line":"        }"},
{"lineNum":"  170","line":""},
{"lineNum":"  171","line":"        RecoverableSignature::from(ret)","class":"lineCov","hits":"1","order":"5813","possible_hits":"1",},
{"lineNum":"  172","line":"    }","class":"linePartCov","hits":"1","order":"5820","possible_hits":"2",},
{"lineNum":"  173","line":"}"},
{"lineNum":"  174","line":""},
...
{"lineNum":"  178","line":"    pub fn recover(&self, msg: &Message, sig: &RecoverableSignature)","class":"lineCov","hits":"1","order":"5398","possible_hits":"1",},
{"lineNum":"  179","line":"                   -> Result<key::PublicKey, Error> {"},
{"lineNum":"  180","line":""},
{"lineNum":"  181","line":"        let mut pk = super_ffi::PublicKey::new();","class":"lineCov","hits":"1","order":"5400","possible_hits":"1",},
{"lineNum":"  182","line":""},
{"lineNum":"  183","line":"        unsafe {"},
{"lineNum":"  184","line":"            if ffi::secp256k1_ecdsa_recover(self.ctx, &mut pk,","class":"lineCov","hits":"2","order":"5402","possible_hits":"2",},
{"lineNum":"  185","line":"                                            sig.as_c_ptr(), msg.as_c_ptr()) != 1 {","class":"lineCov","hits":"1","order":"5403","possible_hits":"1",},
{"lineNum":"  186","line":"                return Err(Error::InvalidSignature);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  187","line":"            }"},
{"lineNum":"  188","line":"        };"},
{"lineNum":"  189","line":"        Ok(key::PublicKey::from(pk))","class":"lineCov","hits":"2","order":"5992","possible_hits":"2",},
{"lineNum":"  190","line":"    }","class":"linePartCov","hits":"2","order":"5996","possible_hits":"3",},
{"lineNum":"  191","line":"}"},
{"lineNum":"  192","line":""},
{"lineNum":"  193","line":""},
...
var header = { "command" : "lightning_invoice-3332d6d4aab2c25c", "date" : "2020-05-23 13:12:48", "instrumented" : 50, "covered" : 45,};
var merged_data = [];
