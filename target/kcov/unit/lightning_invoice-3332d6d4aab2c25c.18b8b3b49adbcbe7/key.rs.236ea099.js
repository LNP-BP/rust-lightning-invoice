...
{"lineNum":"   67","line":"#[derive(Copy, Clone, PartialEq, Eq, Debug, PartialOrd, Ord, Hash)]","class":"linePartCov","hits":"4","order":"2745","possible_hits":"8",},
{"lineNum":"   68","line":"pub struct PublicKey(ffi::PublicKey);","class":"linePartCov","hits":"1","order":"2746","possible_hits":"3",},
{"lineNum":"   69","line":""},
...
{"lineNum":"  131","line":"    pub fn from_slice(data: &[u8])-> Result<SecretKey, Error> {","class":"lineCov","hits":"1","order":"5087","possible_hits":"1",},
{"lineNum":"  132","line":"        match data.len() {","class":"linePartCov","hits":"1","order":"5088","possible_hits":"2",},
{"lineNum":"  133","line":"            constants::SECRET_KEY_SIZE => {","class":"lineCov","hits":"1","order":"5089","possible_hits":"1",},
{"lineNum":"  134","line":"                let mut ret = [0; constants::SECRET_KEY_SIZE];","class":"lineCov","hits":"1","order":"5090","possible_hits":"1",},
{"lineNum":"  135","line":"                unsafe {"},
{"lineNum":"  136","line":"                    if ffi::secp256k1_ec_seckey_verify(","class":"lineCov","hits":"1","order":"5093","possible_hits":"1",},
{"lineNum":"  137","line":"                        ffi::secp256k1_context_no_precomp,","class":"lineCov","hits":"1","order":"5091","possible_hits":"1",},
{"lineNum":"  138","line":"                        data.as_c_ptr(),","class":"lineCov","hits":"1","order":"5092","possible_hits":"1",},
{"lineNum":"  139","line":"                    ) == 0"},
{"lineNum":"  140","line":"                    {"},
{"lineNum":"  141","line":"                        return Err(InvalidSecretKey);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  142","line":"                    }"},
{"lineNum":"  143","line":"                }"},
{"lineNum":"  144","line":"                ret[..].copy_from_slice(data);","class":"lineCov","hits":"2","order":"5101","possible_hits":"2",},
{"lineNum":"  145","line":"                Ok(SecretKey(ret))","class":"lineCov","hits":"1","order":"5102","possible_hits":"1",},
{"lineNum":"  146","line":"            }"},
{"lineNum":"  147","line":"            _ => Err(InvalidSecretKey)","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  148","line":"        }"},
{"lineNum":"  149","line":"    }","class":"linePartCov","hits":"2","order":"5103","possible_hits":"3",},
{"lineNum":"  150","line":""},
...
{"lineNum":"  207","line":"    pub fn as_ptr(&self) -> *const ffi::PublicKey {","class":"lineCov","hits":"1","order":"5242","possible_hits":"1",},
{"lineNum":"  208","line":"        &self.0 as *const _"},
{"lineNum":"  209","line":"    }","class":"linePartCov","hits":"1","order":"5243","possible_hits":"2",},
{"lineNum":"  210","line":""},
...
{"lineNum":"  219","line":"    pub fn from_secret_key<C: Signing>(secp: &Secp256k1<C>,","class":"lineCov","hits":"1","order":"5105","possible_hits":"1",},
{"lineNum":"  220","line":"                           sk: &SecretKey)"},
{"lineNum":"  221","line":"                           -> PublicKey {"},
{"lineNum":"  222","line":"        let mut pk = ffi::PublicKey::new();","class":"lineCov","hits":"1","order":"5106","possible_hits":"1",},
...
{"lineNum":"  226","line":"            let res = ffi::secp256k1_ec_pubkey_create(secp.ctx, &mut pk, sk.as_c_ptr());","class":"lineCov","hits":"1","order":"5107","possible_hits":"1",},
{"lineNum":"  227","line":"            debug_assert_eq!(res, 1);"},
{"lineNum":"  228","line":"        }"},
{"lineNum":"  229","line":"        PublicKey(pk)","class":"lineCov","hits":"1","order":"5149","possible_hits":"1",},
{"lineNum":"  230","line":"    }","class":"lineCov","hits":"1","order":"5150","possible_hits":"1",},
{"lineNum":"  231","line":""},
{"lineNum":"  232","line":"    /// Creates a public key directly from a slice"},
{"lineNum":"  233","line":"    #[inline]"},
{"lineNum":"  234","line":"    pub fn from_slice(data: &[u8]) -> Result<PublicKey, Error> {","class":"lineCov","hits":"1","order":"2410","possible_hits":"1",},
{"lineNum":"  235","line":"        if data.is_empty() {return Err(Error::InvalidPublicKey);}","class":"linePartCov","hits":"1","order":"2411","possible_hits":"2",},
{"lineNum":"  236","line":""},
{"lineNum":"  237","line":"        let mut pk = ffi::PublicKey::new();","class":"lineCov","hits":"1","order":"2414","possible_hits":"1",},
{"lineNum":"  238","line":"        unsafe {"},
{"lineNum":"  239","line":"            if ffi::secp256k1_ec_pubkey_parse(","class":"linePartCov","hits":"1","order":"2423","possible_hits":"2",},
{"lineNum":"  240","line":"                ffi::secp256k1_context_no_precomp,","class":"lineCov","hits":"1","order":"2416","possible_hits":"1",},
{"lineNum":"  241","line":"                &mut pk,"},
{"lineNum":"  242","line":"                data.as_c_ptr(),","class":"lineCov","hits":"1","order":"2417","possible_hits":"1",},
{"lineNum":"  243","line":"                data.len() as usize,","class":"lineCov","hits":"1","order":"2422","possible_hits":"1",},
{"lineNum":"  244","line":"            ) == 1"},
{"lineNum":"  245","line":"            {"},
{"lineNum":"  246","line":"                Ok(PublicKey(pk))","class":"lineCov","hits":"1","order":"2729","possible_hits":"1",},
{"lineNum":"  247","line":"            } else {"},
{"lineNum":"  248","line":"                Err(InvalidPublicKey)","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  249","line":"            }"},
{"lineNum":"  250","line":"        }"},
{"lineNum":"  251","line":"    }","class":"linePartCov","hits":"2","order":"2730","possible_hits":"3",},
{"lineNum":"  252","line":""},
...
{"lineNum":"  257","line":"    pub fn serialize(&self) -> [u8; constants::PUBLIC_KEY_SIZE] {","class":"lineCov","hits":"1","order":"5230","possible_hits":"1",},
{"lineNum":"  258","line":"        let mut ret = [0; constants::PUBLIC_KEY_SIZE];","class":"lineCov","hits":"1","order":"5231","possible_hits":"1",},
{"lineNum":"  259","line":""},
{"lineNum":"  260","line":"        unsafe {"},
{"lineNum":"  261","line":"            let mut ret_len = constants::PUBLIC_KEY_SIZE as usize;","class":"lineCov","hits":"1","order":"5232","possible_hits":"1",},
{"lineNum":"  262","line":"            let err = ffi::secp256k1_ec_pubkey_serialize(","class":"lineCov","hits":"1","order":"5245","possible_hits":"1",},
{"lineNum":"  263","line":"                ffi::secp256k1_context_no_precomp,","class":"lineCov","hits":"1","order":"5233","possible_hits":"1",},
{"lineNum":"  264","line":"                ret.as_mut_c_ptr(),","class":"lineCov","hits":"1","order":"5234","possible_hits":"1",},
{"lineNum":"  265","line":"                &mut ret_len,"},
{"lineNum":"  266","line":"                self.as_c_ptr(),","class":"lineCov","hits":"1","order":"5239","possible_hits":"1",},
{"lineNum":"  267","line":"                ffi::SECP256K1_SER_COMPRESSED,"},
{"lineNum":"  268","line":"            );"},
{"lineNum":"  269","line":"            debug_assert_eq!(err, 1);"},
{"lineNum":"  270","line":"            debug_assert_eq!(ret_len, ret.len());","class":"lineCov","hits":"1","order":"5315","possible_hits":"1",},
{"lineNum":"  271","line":"        }"},
{"lineNum":"  272","line":"        ret","class":"lineCov","hits":"1","order":"5316","possible_hits":"1",},
{"lineNum":"  273","line":"    }","class":"lineCov","hits":"1","order":"5317","possible_hits":"1",},
{"lineNum":"  274","line":""},
...
{"lineNum":"  362","line":"    fn as_c_ptr(&self) -> *const Self::Target {","class":"lineCov","hits":"1","order":"5240","possible_hits":"1",},
{"lineNum":"  363","line":"        self.as_ptr()","class":"lineCov","hits":"1","order":"5241","possible_hits":"1",},
{"lineNum":"  364","line":"    }","class":"linePartCov","hits":"1","order":"5244","possible_hits":"2",},
{"lineNum":"  365","line":""},
...
{"lineNum":"  375","line":"    fn from(pk: ffi::PublicKey) -> PublicKey {","class":"lineCov","hits":"1","order":"5993","possible_hits":"1",},
{"lineNum":"  376","line":"        PublicKey(pk)","class":"lineCov","hits":"1","order":"5994","possible_hits":"1",},
{"lineNum":"  377","line":"    }","class":"linePartCov","hits":"1","order":"5995","possible_hits":"2",},
{"lineNum":"  378","line":"}"},
{"lineNum":"  379","line":""},
...
var header = { "command" : "lightning_invoice-3332d6d4aab2c25c", "date" : "2020-05-23 13:12:48", "instrumented" : 47, "covered" : 44,};
var merged_data = [];
