...
{"lineNum":"   58","line":"    fn from_hex(s: &str) -> Result<Self, Error> {","class":"lineCov","hits":"1","order":"1723","possible_hits":"1",},
{"lineNum":"   59","line":"        Self::from_byte_iter(HexIterator::new(s)?)","class":"linePartCov","hits":"1","order":"1724","possible_hits":"2",},
{"lineNum":"   60","line":"    }","class":"linePartCov","hits":"2","order":"1852","possible_hits":"3",},
{"lineNum":"   61","line":"}"},
{"lineNum":"   62","line":""},
...
{"lineNum":"   72","line":"    fn from_byte_iter<I>(iter: I) -> Result<Self, Error>","class":"linePartCov","hits":"1","order":"1743","possible_hits":"2",},
...
{"lineNum":"   76","line":"    {"},
{"lineNum":"   77","line":"        let inner;","class":"lineCov","hits":"1","order":"1744","possible_hits":"1",},
{"lineNum":"   78","line":"        if Self::DISPLAY_BACKWARD {","class":"linePartCov","hits":"2","order":"1745","possible_hits":"3",},
{"lineNum":"   79","line":"            inner = T::Inner::from_byte_iter(iter.rev())?;","class":"lineNoCov","hits":"0","possible_hits":"4",},
{"lineNum":"   80","line":"        } else {"},
{"lineNum":"   81","line":"            inner = T::Inner::from_byte_iter(iter)?;","class":"linePartCov","hits":"2","order":"1746","possible_hits":"3",},
{"lineNum":"   82","line":"        }"},
{"lineNum":"   83","line":"        Ok(Hash::from_inner(inner))","class":"lineCov","hits":"1","order":"1847","possible_hits":"1",},
{"lineNum":"   84","line":"    }","class":"linePartCov","hits":"2","order":"1851","possible_hits":"3",},
{"lineNum":"   85","line":"}"},
{"lineNum":"   86","line":""},
...
{"lineNum":"   97","line":"    pub fn new(s: &\'a str) -> Result<HexIterator<\'a>, Error> {","class":"lineCov","hits":"1","order":"1725","possible_hits":"1",},
{"lineNum":"   98","line":"        if s.len() % 2 != 0 {","class":"linePartCov","hits":"1","order":"1726","possible_hits":"2",},
{"lineNum":"   99","line":"            Err(Error::OddLengthString(s.len()))","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  100","line":"        } else {"},
{"lineNum":"  101","line":"            Ok(HexIterator { iter: s.bytes() })","class":"lineCov","hits":"2","order":"1730","possible_hits":"2",},
{"lineNum":"  102","line":"        }"},
{"lineNum":"  103","line":"    }","class":"linePartCov","hits":"1","order":"1740","possible_hits":"2",},
{"lineNum":"  104","line":"}"},
{"lineNum":"  105","line":""},
{"lineNum":"  106","line":"fn chars_to_hex(hi: u8, lo: u8) -> Result<u8, Error> {","class":"lineCov","hits":"1","order":"1814","possible_hits":"1",},
{"lineNum":"  107","line":"    let hih = (hi as char)","class":"linePartCov","hits":"3","order":"1815","possible_hits":"4",},
{"lineNum":"  108","line":"        .to_digit(16)"},
{"lineNum":"  109","line":"        .ok_or(Error::InvalidChar(hi))?;","class":"linePartCov","hits":"2","order":"1823","possible_hits":"4",},
{"lineNum":"  110","line":"    let loh = (lo as char)","class":"linePartCov","hits":"3","order":"1824","possible_hits":"4",},
{"lineNum":"  111","line":"        .to_digit(16)"},
{"lineNum":"  112","line":"        .ok_or(Error::InvalidChar(lo))?;","class":"linePartCov","hits":"2","order":"1825","possible_hits":"3",},
{"lineNum":"  113","line":""},
{"lineNum":"  114","line":"    let ret = (hih << 4) + loh;","class":"linePartCov","hits":"2","order":"1826","possible_hits":"4",},
{"lineNum":"  115","line":"    Ok(ret as u8)","class":"lineCov","hits":"1","order":"1827","possible_hits":"1",},
{"lineNum":"  116","line":"}","class":"lineCov","hits":"2","order":"1828","possible_hits":"2",},
{"lineNum":"  117","line":""},
{"lineNum":"  118","line":"impl<\'a> Iterator for HexIterator<\'a> {"},
{"lineNum":"  119","line":"    type Item = Result<u8, Error>;"},
{"lineNum":"  120","line":""},
{"lineNum":"  121","line":"    fn next(&mut self) -> Option<Result<u8, Error>> {","class":"lineCov","hits":"1","order":"1785","possible_hits":"1",},
{"lineNum":"  122","line":"        let hi = self.iter.next()?;","class":"linePartCov","hits":"2","order":"1786","possible_hits":"3",},
{"lineNum":"  123","line":"        let lo = self.iter.next().unwrap();","class":"lineCov","hits":"2","order":"1810","possible_hits":"2",},
{"lineNum":"  124","line":"        Some(chars_to_hex(hi, lo))","class":"lineCov","hits":"1","order":"1813","possible_hits":"1",},
{"lineNum":"  125","line":"    }","class":"linePartCov","hits":"2","order":"1829","possible_hits":"3",},
{"lineNum":"  126","line":""},
{"lineNum":"  127","line":"    fn size_hint(&self) -> (usize, Option<usize>) {","class":"lineCov","hits":"1","order":"1751","possible_hits":"1",},
{"lineNum":"  128","line":"        let (min, max) = self.iter.size_hint();","class":"lineCov","hits":"1","order":"1752","possible_hits":"1",},
{"lineNum":"  129","line":"        (min / 2, max.map(|x| x /2))","class":"lineCov","hits":"3","order":"1762","possible_hits":"3",},
{"lineNum":"  130","line":"    }","class":"linePartCov","hits":"1","order":"1764","possible_hits":"2",},
{"lineNum":"  131","line":"}"},
{"lineNum":"  132","line":""},
...
{"lineNum":"  203","line":"            fn from_byte_iter<I>(iter: I) -> Result<Self, Error>","class":"linePartCov","hits":"1","order":"1747","possible_hits":"4",},
...
{"lineNum":"  207","line":"            {"},
{"lineNum":"  208","line":"                if iter.len() == $len {","class":"linePartCov","hits":"3","order":"1748","possible_hits":"6",},
{"lineNum":"  209","line":"                    let mut ret = [0; $len];","class":"linePartCov","hits":"1","order":"1772","possible_hits":"2",},
{"lineNum":"  210","line":"                    for (n, byte) in iter.enumerate() {","class":"linePartCov","hits":"3","order":"1773","possible_hits":"8",},
{"lineNum":"  211","line":"                        ret[n] = byte?;","class":"linePartCov","hits":"2","order":"1834","possible_hits":"8",},
{"lineNum":"  212","line":"                    }","class":"linePartCov","hits":"1","order":"1844","possible_hits":"6",},
{"lineNum":"  213","line":"                    Ok(ret)","class":"linePartCov","hits":"1","order":"1845","possible_hits":"2",},
{"lineNum":"  214","line":"                } else {"},
{"lineNum":"  215","line":"                    Err(Error::InvalidLength(2 * $len, 2 * iter.len()))","class":"lineNoCov","hits":"0","possible_hits":"8",},
{"lineNum":"  216","line":"                }"},
{"lineNum":"  217","line":"            }","class":"linePartCov","hits":"2","order":"1846","possible_hits":"6",},
{"lineNum":"  218","line":"        }"},
{"lineNum":"  219","line":"    }"},
{"lineNum":"  220","line":"}"},
{"lineNum":"  221","line":""},
...
var header = { "command" : "ser_de-82e03ad9d566398b", "date" : "2020-05-23 13:12:49", "instrumented" : 61, "covered" : 38,};
var merged_data = [];
