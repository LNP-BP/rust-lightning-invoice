...
{"lineNum":"   24","line":"            pub fn as_ptr(&self) -> *const $ty {","class":"lineCov","hits":"1","order":"4919","possible_hits":"1",},
{"lineNum":"   25","line":"                let &$thing(ref dat) = self;","class":"lineCov","hits":"1","order":"4920","possible_hits":"1",},
{"lineNum":"   26","line":"                dat.as_ptr()","class":"lineCov","hits":"1","order":"4921","possible_hits":"1",},
{"lineNum":"   27","line":"            }","class":"linePartCov","hits":"1","order":"4922","possible_hits":"2",},
{"lineNum":"   28","line":""},
...
{"lineNum":"   42","line":"            pub fn is_empty(&self) -> bool { false }","class":"linePartCov","hits":"2","order":"4917","possible_hits":"3",},
{"lineNum":"   43","line":"        }"},
{"lineNum":"   44","line":""},
{"lineNum":"   45","line":"        impl PartialEq for $thing {"},
{"lineNum":"   46","line":"            #[inline]"},
{"lineNum":"   47","line":"            fn eq(&self, other: &$thing) -> bool {","class":"linePartCov","hits":"1","order":"3823","possible_hits":"2",},
{"lineNum":"   48","line":"                &self[..] == &other[..]","class":"linePartCov","hits":"1","order":"3824","possible_hits":"2",},
{"lineNum":"   49","line":"            }","class":"linePartCov","hits":"1","order":"3829","possible_hits":"4",},
{"lineNum":"   50","line":"        }"},
{"lineNum":"   51","line":""},
...
{"lineNum":"  120","line":"            fn index(&self, _: ::core::ops::RangeFull) -> &[$ty] {","class":"linePartCov","hits":"1","order":"3825","possible_hits":"4",},
{"lineNum":"  121","line":"                let &$thing(ref dat) = self;","class":"linePartCov","hits":"1","order":"3826","possible_hits":"4",},
{"lineNum":"  122","line":"                &dat[..]","class":"linePartCov","hits":"1","order":"3827","possible_hits":"4",},
{"lineNum":"  123","line":"            }","class":"linePartCov","hits":"1","order":"3828","possible_hits":"8",},
{"lineNum":"  124","line":"        }"},
{"lineNum":"  125","line":"        impl ::ffi::CPtr for $thing {"},
{"lineNum":"  126","line":"            type Target = $ty;"},
{"lineNum":"  127","line":"            fn as_c_ptr(&self) -> *const Self::Target {","class":"lineCov","hits":"1","order":"4915","possible_hits":"1",},
{"lineNum":"  128","line":"                if self.is_empty() {","class":"lineCov","hits":"2","order":"4916","possible_hits":"2",},
{"lineNum":"  129","line":"                    ::core::ptr::null()","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  130","line":"                } else {"},
{"lineNum":"  131","line":"                    self.as_ptr()","class":"lineCov","hits":"1","order":"4918","possible_hits":"1",},
{"lineNum":"  132","line":"                }"},
{"lineNum":"  133","line":"            }","class":"linePartCov","hits":"1","order":"4923","possible_hits":"2",},
{"lineNum":"  134","line":""},
...
var header = { "command" : "ser_de-82e03ad9d566398b", "date" : "2020-05-23 13:12:49", "instrumented" : 22, "covered" : 16,};
var merged_data = [];
