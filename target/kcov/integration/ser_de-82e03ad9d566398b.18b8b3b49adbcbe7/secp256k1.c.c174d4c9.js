...
{"lineNum":"   78","line":""},
{"lineNum":"   79","line":"size_t secp256k1_context_preallocated_size(unsigned int flags) {","class":"lineCov","hits":"1","order":"3904","possible_hits":"1",},
{"lineNum":"   80","line":"    size_t ret = ROUND_TO_ALIGN(sizeof(secp256k1_context));","class":"lineCov","hits":"1","order":"3905","possible_hits":"1",},
{"lineNum":"   81","line":""},
{"lineNum":"   82","line":"    if (EXPECT((flags & SECP256K1_FLAGS_TYPE_MASK) != SECP256K1_FLAGS_TYPE_CONTEXT, 0)) {","class":"lineCov","hits":"1","order":"3906","possible_hits":"1",},
...
{"lineNum":"   86","line":"    }"},
{"lineNum":"   87","line":""},
{"lineNum":"   88","line":"    if (flags & SECP256K1_FLAGS_BIT_CONTEXT_SIGN) {","class":"lineCov","hits":"1","order":"3907","possible_hits":"1",},
{"lineNum":"   89","line":"        ret += SECP256K1_ECMULT_GEN_CONTEXT_PREALLOCATED_SIZE;","class":"lineCov","hits":"1","order":"3908","possible_hits":"1",},
{"lineNum":"   90","line":"    }"},
{"lineNum":"   91","line":"    if (flags & SECP256K1_FLAGS_BIT_CONTEXT_VERIFY) {","class":"lineCov","hits":"1","order":"3909","possible_hits":"1",},
{"lineNum":"   92","line":"        ret += SECP256K1_ECMULT_CONTEXT_PREALLOCATED_SIZE;","class":"lineCov","hits":"1","order":"3910","possible_hits":"1",},
{"lineNum":"   93","line":"    }"},
{"lineNum":"   94","line":"    return ret;","class":"lineCov","hits":"1","order":"3911","possible_hits":"1",},
{"lineNum":"   95","line":"}","class":"linePartCov","hits":"1","order":"3912","possible_hits":"2",},
{"lineNum":"   96","line":""},
...
{"lineNum":"  107","line":"}"},
{"lineNum":"  108","line":""},
{"lineNum":"  109","line":"secp256k1_context* secp256k1_context_preallocated_create(void* prealloc, unsigned int flags) {","class":"lineCov","hits":"1","order":"3949","possible_hits":"1",},
{"lineNum":"  110","line":"    void* const base = prealloc;","class":"lineCov","hits":"1","order":"3950","possible_hits":"1",},
{"lineNum":"  111","line":"    size_t prealloc_size;"},
{"lineNum":"  112","line":"    secp256k1_context* ret;"},
{"lineNum":"  113","line":""},
{"lineNum":"  114","line":"    VERIFY_CHECK(prealloc != NULL);"},
{"lineNum":"  115","line":"    prealloc_size = secp256k1_context_preallocated_size(flags);","class":"lineCov","hits":"1","order":"3951","possible_hits":"1",},
{"lineNum":"  116","line":"    ret = (secp256k1_context*)manual_alloc(&prealloc, sizeof(secp256k1_context), base, prealloc_size);","class":"lineCov","hits":"1","order":"3952","possible_hits":"1",},
{"lineNum":"  117","line":"    ret->illegal_callback = default_illegal_callback;","class":"lineCov","hits":"1","order":"3959","possible_hits":"1",},
{"lineNum":"  118","line":"    ret->error_callback = default_error_callback;","class":"lineCov","hits":"1","order":"3960","possible_hits":"1",},
{"lineNum":"  119","line":""},
{"lineNum":"  120","line":"    if (EXPECT((flags & SECP256K1_FLAGS_TYPE_MASK) != SECP256K1_FLAGS_TYPE_CONTEXT, 0)) {","class":"lineCov","hits":"1","order":"3961","possible_hits":"1",},
...
{"lineNum":"  124","line":"    }"},
{"lineNum":"  125","line":""},
{"lineNum":"  126","line":"    secp256k1_ecmult_context_init(&ret->ecmult_ctx);","class":"lineCov","hits":"1","order":"3962","possible_hits":"1",},
{"lineNum":"  127","line":"    secp256k1_ecmult_gen_context_init(&ret->ecmult_gen_ctx);","class":"lineCov","hits":"1","order":"3966","possible_hits":"1",},
{"lineNum":"  128","line":""},
{"lineNum":"  129","line":"    if (flags & SECP256K1_FLAGS_BIT_CONTEXT_SIGN) {","class":"lineCov","hits":"1","order":"3970","possible_hits":"1",},
{"lineNum":"  130","line":"        secp256k1_ecmult_gen_context_build(&ret->ecmult_gen_ctx, &prealloc);","class":"lineCov","hits":"1","order":"3971","possible_hits":"1",},
{"lineNum":"  131","line":"    }"},
{"lineNum":"  132","line":"    if (flags & SECP256K1_FLAGS_BIT_CONTEXT_VERIFY) {","class":"lineCov","hits":"1","order":"4853","possible_hits":"1",},
{"lineNum":"  133","line":"        secp256k1_ecmult_context_build(&ret->ecmult_ctx, &prealloc);","class":"lineCov","hits":"1","order":"4854","possible_hits":"1",},
{"lineNum":"  134","line":"    }"},
{"lineNum":"  135","line":""},
{"lineNum":"  136","line":"    return (secp256k1_context*) ret;","class":"lineCov","hits":"1","order":"4902","possible_hits":"1",},
{"lineNum":"  137","line":"}","class":"linePartCov","hits":"1","order":"4903","possible_hits":"2",},
{"lineNum":"  138","line":""},
...
{"lineNum":"  151","line":"}"},
{"lineNum":"  152","line":""},
{"lineNum":"  153","line":"void secp256k1_context_preallocated_destroy(secp256k1_context* ctx) {","class":"lineCov","hits":"1","order":"5337","possible_hits":"1",},
{"lineNum":"  154","line":"    ARG_CHECK_NO_RETURN(ctx != secp256k1_context_no_precomp);","class":"lineCov","hits":"1","order":"5338","possible_hits":"1",},
{"lineNum":"  155","line":"    if (ctx != NULL) {","class":"lineCov","hits":"1","order":"5339","possible_hits":"1",},
{"lineNum":"  156","line":"        secp256k1_ecmult_context_clear(&ctx->ecmult_ctx);","class":"lineCov","hits":"1","order":"5340","possible_hits":"1",},
{"lineNum":"  157","line":"        secp256k1_ecmult_gen_context_clear(&ctx->ecmult_gen_ctx);","class":"lineCov","hits":"1","order":"5344","possible_hits":"1",},
{"lineNum":"  158","line":"    }"},
{"lineNum":"  159","line":"}","class":"linePartCov","hits":"1","order":"5350","possible_hits":"2",},
{"lineNum":"  160","line":""},
...
{"lineNum":"  177","line":"}"},
{"lineNum":"  178","line":""},
{"lineNum":"  179","line":"static int secp256k1_pubkey_load(const secp256k1_context* ctx, secp256k1_ge* ge, const secp256k1_pubkey* pubkey) {","class":"lineCov","hits":"2","order":"5478","possible_hits":"2",},
...
{"lineNum":"  185","line":"        memcpy(&s, &pubkey->data[0], sizeof(s));","class":"lineCov","hits":"1","order":"5479","possible_hits":"1",},
{"lineNum":"  186","line":"        secp256k1_ge_from_storage(ge, &s);","class":"lineCov","hits":"1","order":"5480","possible_hits":"1",},
...
{"lineNum":"  193","line":"    }"},
{"lineNum":"  194","line":"    ARG_CHECK(!secp256k1_fe_is_zero(&ge->x));","class":"lineCov","hits":"1","order":"5481","possible_hits":"1",},
{"lineNum":"  195","line":"    return 1;","class":"lineCov","hits":"1","order":"5482","possible_hits":"1",},
{"lineNum":"  196","line":"}","class":"linePartCov","hits":"1","order":"5483","possible_hits":"2",},
{"lineNum":"  197","line":""},
{"lineNum":"  198","line":"static void secp256k1_pubkey_save(secp256k1_pubkey* pubkey, secp256k1_ge* ge) {","class":"lineCov","hits":"2","order":"5322","possible_hits":"2",},
{"lineNum":"  199","line":"    if (sizeof(secp256k1_ge_storage) == 64) {"},
{"lineNum":"  200","line":"        secp256k1_ge_storage s;"},
{"lineNum":"  201","line":"        secp256k1_ge_to_storage(&s, ge);","class":"lineCov","hits":"1","order":"5323","possible_hits":"1",},
{"lineNum":"  202","line":"        memcpy(&pubkey->data[0], &s, sizeof(s));","class":"lineCov","hits":"1","order":"5324","possible_hits":"1",},
...
{"lineNum":"  209","line":"    }"},
{"lineNum":"  210","line":"}","class":"linePartCov","hits":"1","order":"5325","possible_hits":"2",},
{"lineNum":"  211","line":""},
{"lineNum":"  212","line":"int secp256k1_ec_pubkey_parse(const secp256k1_context* ctx, secp256k1_pubkey* pubkey, const unsigned char *input, size_t inputlen) {","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  213","line":"    secp256k1_ge Q;"},
{"lineNum":"  214","line":""},
{"lineNum":"  215","line":"    VERIFY_CHECK(ctx != NULL);"},
{"lineNum":"  216","line":"    ARG_CHECK(pubkey != NULL);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  217","line":"    memset(pubkey, 0, sizeof(*pubkey));","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  218","line":"    ARG_CHECK(input != NULL);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  219","line":"    if (!secp256k1_eckey_pubkey_parse(&Q, input, inputlen)) {","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  220","line":"        return 0;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  221","line":"    }"},
{"lineNum":"  222","line":"    secp256k1_pubkey_save(pubkey, &Q);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  223","line":"    secp256k1_ge_clear(&Q);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  224","line":"    return 1;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  225","line":"}","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  226","line":""},
{"lineNum":"  227","line":"int secp256k1_ec_pubkey_serialize(const secp256k1_context* ctx, unsigned char *output, size_t *outputlen, const secp256k1_pubkey* pubkey, unsigned int flags) {","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  228","line":"    secp256k1_ge Q;"},
{"lineNum":"  229","line":"    size_t len;"},
{"lineNum":"  230","line":"    int ret = 0;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  231","line":""},
{"lineNum":"  232","line":"    VERIFY_CHECK(ctx != NULL);"},
{"lineNum":"  233","line":"    ARG_CHECK(outputlen != NULL);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  234","line":"    ARG_CHECK(*outputlen >= ((flags & SECP256K1_FLAGS_BIT_COMPRESSION) ? 33 : 65));","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  235","line":"    len = *outputlen;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  236","line":"    *outputlen = 0;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  237","line":"    ARG_CHECK(output != NULL);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  238","line":"    memset(output, 0, len);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  239","line":"    ARG_CHECK(pubkey != NULL);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  240","line":"    ARG_CHECK((flags & SECP256K1_FLAGS_TYPE_MASK) == SECP256K1_FLAGS_TYPE_COMPRESSION);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  241","line":"    if (secp256k1_pubkey_load(ctx, &Q, pubkey)) {","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  242","line":"        ret = secp256k1_eckey_pubkey_serialize(&Q, output, &len, flags & SECP256K1_FLAGS_BIT_COMPRESSION);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  243","line":"        if (ret) {","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  244","line":"            *outputlen = len;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  245","line":"        }"},
{"lineNum":"  246","line":"    }"},
{"lineNum":"  247","line":"    return ret;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  248","line":"}","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  249","line":""},
{"lineNum":"  250","line":"static void secp256k1_ecdsa_signature_load(const secp256k1_context* ctx, secp256k1_scalar* r, secp256k1_scalar* s, const secp256k1_ecdsa_signature* sig) {","class":"lineCov","hits":"1","order":"5461","possible_hits":"1",},
...
{"lineNum":"  256","line":"        memcpy(r, &sig->data[0], 32);","class":"lineCov","hits":"1","order":"5462","possible_hits":"1",},
{"lineNum":"  257","line":"        memcpy(s, &sig->data[32], 32);","class":"lineCov","hits":"1","order":"5463","possible_hits":"1",},
...
{"lineNum":"  261","line":"    }"},
{"lineNum":"  262","line":"}","class":"linePartCov","hits":"1","order":"5464","possible_hits":"2",},
{"lineNum":"  263","line":""},
{"lineNum":"  264","line":"static void secp256k1_ecdsa_signature_save(secp256k1_ecdsa_signature* sig, const secp256k1_scalar* r, const secp256k1_scalar* s) {","class":"lineCov","hits":"1","order":"5429","possible_hits":"1",},
{"lineNum":"  265","line":"    if (sizeof(secp256k1_scalar) == 32) {"},
{"lineNum":"  266","line":"        memcpy(&sig->data[0], r, 32);","class":"lineCov","hits":"1","order":"5430","possible_hits":"1",},
{"lineNum":"  267","line":"        memcpy(&sig->data[32], s, 32);","class":"lineCov","hits":"1","order":"5431","possible_hits":"1",},
...
{"lineNum":"  271","line":"    }"},
{"lineNum":"  272","line":"}","class":"linePartCov","hits":"1","order":"5432","possible_hits":"2",},
{"lineNum":"  273","line":""},
...
{"lineNum":"  353","line":"}"},
{"lineNum":"  354","line":""},
{"lineNum":"  355","line":"int secp256k1_ecdsa_verify(const secp256k1_context* ctx, const secp256k1_ecdsa_signature *sig, const unsigned char *msg32, const secp256k1_pubkey *pubkey) {","class":"lineCov","hits":"2","order":"5454","possible_hits":"2",},
...
{"lineNum":"  360","line":"    ARG_CHECK(secp256k1_ecmult_context_is_built(&ctx->ecmult_ctx));","class":"lineCov","hits":"1","order":"5455","possible_hits":"1",},
{"lineNum":"  361","line":"    ARG_CHECK(msg32 != NULL);","class":"lineCov","hits":"1","order":"5456","possible_hits":"1",},
{"lineNum":"  362","line":"    ARG_CHECK(sig != NULL);","class":"lineCov","hits":"1","order":"5457","possible_hits":"1",},
{"lineNum":"  363","line":"    ARG_CHECK(pubkey != NULL);","class":"lineCov","hits":"1","order":"5458","possible_hits":"1",},
{"lineNum":"  364","line":""},
{"lineNum":"  365","line":"    secp256k1_scalar_set_b32(&m, msg32, NULL);","class":"lineCov","hits":"1","order":"5459","possible_hits":"1",},
{"lineNum":"  366","line":"    secp256k1_ecdsa_signature_load(ctx, &r, &s, sig);","class":"lineCov","hits":"1","order":"5460","possible_hits":"1",},
{"lineNum":"  367","line":"    return (!secp256k1_scalar_is_high(&s) &&","class":"lineCov","hits":"3","order":"5465","possible_hits":"3",},
{"lineNum":"  368","line":"            secp256k1_pubkey_load(ctx, &q, pubkey) &&","class":"lineCov","hits":"2","order":"5477","possible_hits":"2",},
{"lineNum":"  369","line":"            secp256k1_ecdsa_sig_verify(&ctx->ecmult_ctx, &r, &s, &q, &m));","class":"lineCov","hits":"1","order":"5484","possible_hits":"1",},
{"lineNum":"  370","line":"}","class":"lineCov","hits":"1","order":"5526","possible_hits":"1",},
{"lineNum":"  371","line":""},
{"lineNum":"  372","line":"static SECP256K1_INLINE void buffer_append(unsigned char *buf, unsigned int *offset, const void *data, unsigned int len) {"},
{"lineNum":"  373","line":"    memcpy(buf + *offset, data, len);"},
{"lineNum":"  374","line":"    *offset += len;"},
{"lineNum":"  375","line":"}"},
{"lineNum":"  376","line":""},
{"lineNum":"  377","line":"static int nonce_function_rfc6979(unsigned char *nonce32, const unsigned char *msg32, const unsigned char *key32, const unsigned char *algo16, void *data, unsigned int counter) {"},
{"lineNum":"  378","line":"   unsigned char keydata[112];"},
{"lineNum":"  379","line":"   unsigned int offset = 0;"},
...
{"lineNum":"  389","line":"    */"},
{"lineNum":"  390","line":"   buffer_append(keydata, &offset, key32, 32);"},
{"lineNum":"  391","line":"   buffer_append(keydata, &offset, msg32, 32);"},
{"lineNum":"  392","line":"   if (data != NULL) {"},
{"lineNum":"  393","line":"       buffer_append(keydata, &offset, data, 32);"},
{"lineNum":"  394","line":"   }"},
{"lineNum":"  395","line":"   if (algo16 != NULL) {"},
{"lineNum":"  396","line":"       buffer_append(keydata, &offset, algo16, 16);"},
{"lineNum":"  397","line":"   }"},
{"lineNum":"  398","line":"   secp256k1_rfc6979_hmac_sha256_initialize(&rng, keydata, offset);"},
{"lineNum":"  399","line":"   memset(keydata, 0, sizeof(keydata));"},
{"lineNum":"  400","line":"   for (i = 0; i <= counter; i++) {"},
{"lineNum":"  401","line":"       secp256k1_rfc6979_hmac_sha256_generate(&rng, nonce32, 32);"},
{"lineNum":"  402","line":"   }"},
{"lineNum":"  403","line":"   secp256k1_rfc6979_hmac_sha256_finalize(&rng);"},
{"lineNum":"  404","line":"   return 1;"},
{"lineNum":"  405","line":"}"},
{"lineNum":"  406","line":""},
...
{"lineNum":"  454","line":"}"},
{"lineNum":"  455","line":""},
{"lineNum":"  456","line":"int secp256k1_ec_seckey_verify(const secp256k1_context* ctx, const unsigned char *seckey) {"},
...
{"lineNum":"  461","line":"    ARG_CHECK(seckey != NULL);"},
{"lineNum":"  462","line":""},
{"lineNum":"  463","line":"    secp256k1_scalar_set_b32(&sec, seckey, &overflow);"},
{"lineNum":"  464","line":"    ret = !overflow && !secp256k1_scalar_is_zero(&sec);"},
{"lineNum":"  465","line":"    secp256k1_scalar_clear(&sec);"},
{"lineNum":"  466","line":"    return ret;"},
{"lineNum":"  467","line":"}"},
{"lineNum":"  468","line":""},
{"lineNum":"  469","line":"int secp256k1_ec_pubkey_create(const secp256k1_context* ctx, secp256k1_pubkey *pubkey, const unsigned char *seckey) {"},
...
{"lineNum":"  474","line":"    int ret = 0;"},
{"lineNum":"  475","line":"    VERIFY_CHECK(ctx != NULL);"},
{"lineNum":"  476","line":"    ARG_CHECK(pubkey != NULL);"},
{"lineNum":"  477","line":"    memset(pubkey, 0, sizeof(*pubkey));"},
{"lineNum":"  478","line":"    ARG_CHECK(secp256k1_ecmult_gen_context_is_built(&ctx->ecmult_gen_ctx));"},
{"lineNum":"  479","line":"    ARG_CHECK(seckey != NULL);"},
{"lineNum":"  480","line":""},
{"lineNum":"  481","line":"    secp256k1_scalar_set_b32(&sec, seckey, &overflow);"},
{"lineNum":"  482","line":"    ret = (!overflow) & (!secp256k1_scalar_is_zero(&sec));"},
{"lineNum":"  483","line":"    if (ret) {"},
{"lineNum":"  484","line":"        secp256k1_ecmult_gen(&ctx->ecmult_gen_ctx, &pj, &sec);"},
{"lineNum":"  485","line":"        secp256k1_ge_set_gej(&p, &pj);"},
{"lineNum":"  486","line":"        secp256k1_pubkey_save(pubkey, &p);"},
{"lineNum":"  487","line":"    }"},
{"lineNum":"  488","line":"    secp256k1_scalar_clear(&sec);"},
{"lineNum":"  489","line":"    return ret;"},
{"lineNum":"  490","line":"}"},
{"lineNum":"  491","line":""},
...
var header = { "command" : "ser_de-82e03ad9d566398b", "date" : "2020-05-23 13:12:49", "instrumented" : 89, "covered" : 59,};
var merged_data = [];
